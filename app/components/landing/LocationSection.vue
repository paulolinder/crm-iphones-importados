  ...
  <section class="border-b border-zinc-200/80 bg-white py-16 sm:py-20">
    <div class="eleve-container">
      <div class="mx-auto max-w-2xl rounded-2xl border border-zinc-200 bg-[var(--eleve-surface)] px-6 py-10 text-center sm:px-10 sm:py-12">
        ...
        <p class="mt-4 text-lg font-medium text-zinc-800">
          Campo Novo do Parecis — Mato Grosso
        </p>
        <p class="mt-3 text-sm leading-relaxed text-zinc-600 sm:text-base">
          <strong class="font-semibold text-zinc-800">Entrega grátis</strong> na cidade.
          Fora da região? Chame no WhatsApp e veja o que conseguimos combinar.
        </p>
      </div>
    </div>
  </section>
