...
<template>
  <div class="p-4 lg:p-8 space-y-6">
    <AppPageHeader
      title="Novo pedido"
      description="Registre um pedido com cliente, itens e forma de pagamento"
      :breadcrumbs="[
        { label: 'Pedidos', to: '/admin/pedidos' },
        { label: 'Novo pedido' },
      ]"
      :actions="[
        { key: 'back', label: 'Voltar', variant: 'outline', to: '/admin/pedidos' },
      ]"
    />
    ...
    <div class="max-w-4xl bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
      <form class="space-y-5" @submit.prevent="handleSubmit">
        ...
        <div class="space-y-4">
          ...
          >
            <div>
              ...
              <select v-model="item.product_id" class="form-input" required @change="updateItemPrice(index)">
                <option value="" disabled>
                  Selecione
                </option>
            ...
            <div>
              ...
              <input v-model.number="item.unit_price" type="number" min="0" step="0.01" class="form-input" required>
            </div>
          </div>
        ...
        <div class="flex items-center justify-end gap-3">
          <NuxtLink to="/admin/pedidos" class="btn-outline">
            Cancelar
          </NuxtLink>
